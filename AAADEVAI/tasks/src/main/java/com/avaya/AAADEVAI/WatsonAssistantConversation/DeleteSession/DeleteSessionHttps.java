...
public class DeleteSessionHttps {
	private final String sessionDeleteSession;

	public DeleteSessionHttps(String sessionDeleteSession) {
		super();
		this.sessionDeleteSession = sessionDeleteSession;
	}
	
	public JSONObject deleteSession() throws SSLUtilityException, ClientProtocolException, IOException, JSONException{
		...
		StringBody actionPart = new StringBody(new AES().encrypt("deleteSessionAssistantConversation"), ContentType.TEXT_PLAIN);
		StringBody sessionIdPart = new StringBody(new AES().encrypt(sessionDeleteSession), ContentType.TEXT_PLAIN);
