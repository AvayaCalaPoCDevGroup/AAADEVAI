...
public class Google {
	public JSONObject googleTTS(String text, String voice, String voiceName) throws SSLUtilityException, ClientProtocolException, IOException, JSONException{
		...
		final HttpPost postMethod = new HttpPost(Constants.GOOGLE_BREEZE_END_POINT_TTS);
		...
		StringBody voiceNameBody = new StringBody(voiceName.trim(), ContentType.TEXT_PLAIN);
		
		builder.addPart("text", textBody);
		builder.addPart("voice", voiceBody);
		builder.addPart("voiceName", voiceNameBody);
